...
const AppSidebar: React.FC = () => {
  ...
  const navItems: NavItem[] = useMemo(() => [{ name: 'Dashboard', path: '/dashboard' }], []);
          ...
          {nav.subItems && (isExpanded || isHovered || isMobileOpen) && (
            ...
            >
              <ul className="mt-2 space-y-1 ml-9">
                {nav.subItems.map((subItem: NavSubItem) => (
                  <li key={subItem.name}>
                    <Link
                      to={subItem.path}
        ...
        <Link to={`/dashboard`}>
          {isExpanded || isHovered || isMobileOpen ? (
            <>
              ...
              <img
                className=" dark:[filter:invert(1)] w-[20vh]"
            ...
            <>
              <div className="flex justify-center items-center flex-col gap-3 ">
                <img
                className="dark:hidden w-[6vh] "
                src="/images/logo/Logo5.png"
                alt="Logo"
              />
              <img
                className="dark:block w-[20vh]"
                src="/images/logo/Logo5.png"
                alt="Logo"
              />
              </div>
