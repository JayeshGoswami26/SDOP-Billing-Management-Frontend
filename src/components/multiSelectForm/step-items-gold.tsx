// Designed separately in case gold rules diverge later
"use client"
...
export default function StepItemsGold({ onBack, onNext, billType }: StepItemsGoldProps) {
  const [items, setItems] = useState<BillItem[]>([])
  // Different default GST for gold can be applied here later
